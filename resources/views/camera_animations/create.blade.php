            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700 dark:text-blue-400">
                        <p><strong>Archivo .MP4:</strong> Ahora solo necesitas subir un único archivo de video en formato MP4.</p>
                        <p class="mt-2">Asegúrate de que el video contenga la animación con <strong>fondo de color verde puro (chroma key)</strong>. El sistema se encargará de eliminar el fondo automáticamente.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
            <form action="{{ route('camera-animations.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-6">
                ...
                <div class="flex flex-col gap-2">
                    <label class="text-sm font-medium text-neutral-800 dark:text-neutral-200">Archivo .MP4 (Pantalla Verde)</label>
