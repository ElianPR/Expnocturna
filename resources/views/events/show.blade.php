        ...
        <section class="w-full overflow-hidden rounded-[2rem] bg-[#f3efe8] shadow-sm ring-1 ring-black/5">
            ...
            <div class="px-5 pb-8 pt-7">
                <div class="space-y-3 text-center">
                    <flux:heading level="1" class="text-[2.2rem] font-medium leading-none tracking-tight text-neutral-900">
                ...
                <div class="mt-6 space-y-4">
                    <div class="rounded-[1.75rem] bg-[#d9ecfb] px-4 py-4">
                        <div class="flex items-start gap-3">
                            <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-white/70 text-xl">
                                🦋
                            </div>
                ...
                <div class="mt-6">
                    <flux:button
                        ...
                        :href="route('events.share.create', $event->id_hex)"
                        icon="share"
