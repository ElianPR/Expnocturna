<x-layouts.app>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cinzel:wght@600;700&family=Great+Vibes&family=Poppins:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500&family=Playfair+Display:ital,wght@0,400..900;1,400..900&display=swap"
        rel="stylesheet">
    ...
    <script>
        window.previewData = function() {
            return {
                ...
                cover_expiration: {!! json_encode(old('cover_expiration', '')) !!},
                album_expiration: {!! json_encode(old('album_expiration', '')) !!},
                album_availability: {!! json_encode(old('album_availability', '')) !!},
