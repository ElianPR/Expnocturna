                        ...
                        @forelse ($events as $event)
                            @php
                                ...
                                if ($event->date) {
                                    ...
                                    if (!$event->is_active) {
                                        if (
                                            $event->cover_expiration &&
                                            $today->diffInDays($event->cover_expiration, false) < 0
                                        ) {
                                            ...
                                            $eventoColor =
                                                'bg-yellow-100 text-yellow-700 border-yellow-300 dark:bg-yellow-900/50 dark:text-yellow-300 dark:border-yellow-800';
                                        } else {
                                            $eventoAviso = 'En Espera';
                                            $eventoColor =
                                                'bg-blue-100 text-blue-700 border-blue-300 dark:bg-blue-900/50 dark:text-blue-300 dark:border-blue-800';
                                        }
                                    } else {
                                        if ($event->cover_expiration) {
                                            ...
                                            if ($diffExp < 0) {
                                                ...
                                                $eventoColor =
                                                    'bg-orange-100 text-orange-700 border-orange-300 dark:bg-orange-900/50 dark:text-orange-300 dark:border-orange-800';
                                            }
                                        }
                                    }
                                }
                                ...
                                if ($event->album_availability) {
                                    ...
                                    if (!$event->album_active) {
                                        if (
                                            $event->album_expiration &&
                                            $today->diffInDays($event->album_expiration, false) < 0
                                        ) {
                            ...
                            <tr class="border-t border-neutral-200 dark:border-neutral-700">
                                    ...
                                    <div class="flex flex-col gap-3">
                                        <div>
                                            <div class="flex items-center gap-2 mb-1">
                                                <span
                                                    class="text-[10px] font-bold uppercase tracking-wider text-neutral-500">Evento</span>
                                                @if ($eventoAviso)
                                                    <span
                                                        class="text-[9px] font-bold px-2 py-0.5 rounded border {{ $eventoColor }}">{{ $eventoAviso }}</span>
                                                @endif
                                            </div>
                                        ...
                                        <div>
                                            <div class="flex items-center gap-2 mb-1">
                                                <span
                                                    class="text-[10px] font-bold uppercase tracking-wider text-neutral-500">Álbum</span>
                                                @if ($albumAviso)
                                                    <span
                                                        class="text-[9px] font-bold px-2 py-0.5 rounded border {{ $albumColor }}">{{ $albumAviso }}</span>
                                                @endif
                                            </div>
                                            <span class="text-neutral-700 dark:text-neutral-300 whitespace-nowrap">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <div x-data="{
                                        ...
                                        "
                                            ...
                                            <div x-show="loading"
                                                class="absolute inset-0 flex items-center justify-center" x-cloak>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <div x-data="{ copied: false }" class="flex items-center gap-2">
                                            <div class="w-16">
                                                <a href="{{ url('/album/' . bin2hex($event->album)) }}"
                                                    target="_blank"
